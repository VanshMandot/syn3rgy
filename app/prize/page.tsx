...
//     if (isMobile) {
//       switch (id) {
//         // Increased scale from 0.75 to 0.85 and adjusted Y positions for larger mobile cards
...
//       // Increased base mobile width/height for bigger cards
...
//             <div className="text-white text-2xl md:text-4xl font-black">{prize}</div>
//           </div>
//         </div>
...
//       <div className="fixed inset-0 z-0 bg-center bg-cover" style={{ backgroundImage: "url('/bgimage.png')", filter: 'brightness(1.1) contrast(1.1)' }} />
...
//       <div ref={gunRef} className={`fixed left-1/2 w-[220px] md:w-[400px] h-[350px] md:h-[600px] z-[2000] pointer-events-none -translate-x-1/2 transition-all duration-300 ease-out ${isFiring ? 'animate-recoil' : ''} ${revealedIds.length >= 3 ? '-bottom-96 opacity-0' : '-bottom-4 md:-bottom-32 opacity-100'}`}>
