...
const TIMELINE_DATA = [
  ...
  { date: "March 28ΓÇô29, 2026", title: "Hackathon Begins", desc: "24-hour coding marathon. Build, innovate, and collaborate." },
...
const DOMAINS_DATA = [
  { icon: "≡ƒñû", title: "Artificial Intelligence", desc: "Build intelligent systems using machine learning, NLP, and computer vision to solve real-world problems." },
  { icon: "≡ƒîÉ", title: "Web3 & Blockchain", desc: "Create decentralized applications, smart contracts, and explore the future of distributed systems." },
  { icon: "≡ƒ¢í∩╕Å", title: "Cybersecurity", desc: "Design security tools, vulnerability scanners, and defend against modern cyber threats." },
  { icon: "≡ƒô▒", title: "IoT & Hardware", desc: "Connect the physical and digital worlds with innovative IoT solutions and embedded systems." },
  { icon: "≡ƒî┐", title: "Sustainability", desc: "Leverage technology to address environmental challenges and build a greener future." },
  { icon: "≡ƒÅÑ", title: "HealthTech", desc: "Innovate in healthcare with AI diagnostics, telemedicine, and patient care solutions." },
];

const GUIDELINES_DATA = [
  { title: "Team Size", text: "Teams must consist of 2ΓÇô4 members. Individual participation is not allowed." },
...
const FAQ_DATA = [
  ...
  { q: "Can I participate solo?", a: "No, SYNERGY 3.0 is a team event. You must have a team of 2ΓÇô4 members to participate." },
  ...
  { q: "What should I bring?", a: "Bring your laptop, charger, student ID, and any hardware you might need. We'll provide the rest ΓÇö Wi-Fi, power, space, and inspiration!" },
];
    ...
    <main>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          <span className={styles.heroTag}>≡ƒÜÇ National Level Hackathon</span>
          ...
          <div className={styles.contactGrid}>
            <div className={styles.contactInfo}>
              ...
              <p className={styles.contactInfoDesc}>
                ...
                domains, or logistics ΓÇö feel free to reach out.
              </p>
              <div className={styles.contactItem}>
                <div className={styles.contactIcon}>≡ƒôº</div>
                <div>
              ...
              <div className={styles.contactItem}>
                <div className={styles.contactIcon}>≡ƒô₧</div>
                <div>
              ...
              <div className={styles.contactItem}>
                <div className={styles.contactIcon}>≡ƒôì</div>
                <div>
          ...
          <div className={styles.faqList}>
            {FAQ_DATA.map((item, i) => (
              ...
              >
                ...
                >
                  <span>{item.q}</span>
                  <span className={styles.faqChevron}>Γû╛</span>
                </button>
      ...
      <footer className={styles.footer}>
        <div className="container">
          ...
          <div className={styles.footerSocials}>
            <a href="#" className={styles.socialLink} aria-label="Instagram">≡ƒô╕</a>
            <a href="#" className={styles.socialLink} aria-label="Twitter">≡ƒÉª</a>
            <a href="#" className={styles.socialLink} aria-label="LinkedIn">≡ƒÆ╝</a>
            <a href="#" className={styles.socialLink} aria-label="Discord">≡ƒÄ«</a>
          </div>
          <p className={styles.footerCopy}>
            ┬⌐ 2026 SYNERGY 3.0. All rights reserved. Made with ≡ƒÆ£
          </p>
        </div>
      </footer>
    </main>
